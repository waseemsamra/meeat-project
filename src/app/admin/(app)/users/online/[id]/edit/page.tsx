...
export default function EditOnlineCustomerPage() {
  ...
  if (isLoading) {
    return (
      <div>
        <h1 className="text-3xl font-bold mb-8">Edit Online Customer</h1>
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8">Edit Online Customer</h1>
      <CustomerForm customer={customer} isOnlineCustomer={true} />
    </div>
  );
}
