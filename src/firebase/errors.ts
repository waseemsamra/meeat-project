...
async function buildRequestObject(context: SecurityRuleContext): Promise<SecurityRuleRequest> {
  ...
  try {
    ...
    await firebaseAuth.authStateReady(); // Wait for auth state to be loaded
...
export class FirestorePermissionError extends Error {
  ...
  /**
   * IMPORTANT: The constructor is private. Use the static `create` method instead.
   */
   ...
   * This is necessary because we need to asynchronously wait for the auth state.
   * @param context The context of the failed Firestore operation.
